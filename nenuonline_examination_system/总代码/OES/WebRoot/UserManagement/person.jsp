					...
					<div class="personInfor">
						...
						<div class="schoolInform">
							<table border="" cellspacing="" cellpadding="">
								<tr><td class="inforTitle">学校:</td><td class="inforValue"><%=user.getUserSchool() %></td></tr>
								<tr><td class="inforTitle">学号:</td><td class="inforValue">2017036478</td></tr>
								<tr><td class="inforTitle">姓名:</td><td class="inforValue"><%=user.getUserName() %></td></tr>
								<tr><td class="inforTitle">年级:</td><td class="inforValue"><%=user.getUserGrade() %></td></tr>
								<tr><td class="inforTitle">班级:</td><td class="inforValue"><%=user.getUserClass() %></td></tr>
								<tr><td class="inforTitle">电话:</td><td class="inforValue"><%=user.getUserTel() %></td></tr>
								<tr><td class="inforTitle">住址:</td><td class="inforValue"><%=user.getUserAdr() %></td></tr>
								<tr><td class="inforTitle">简介:</td><td class="inforValue"><%=user.getIntroduction() %></td></tr>
							</table>
							
							<!-- 修改信息 -->
							<button type="button" onclick="window.location.href='changeInformation.jsp'">修改信息</button>
						</div>
